...
impl Builtin {
    pub fn name(self) -> &'static str {
        match self {
            ...
            Builtin::ReadImage => "read_image",
            Builtin::LoadImageDataset => "load_image_dataset",
            Builtin::Save => "save",
            Builtin::Load => "load",
            ...
            Builtin::LoadSpriteSheet => "load_sprite_sheet",
            Builtin::DrawSprite => "draw_sprite",
            Builtin::DrawSpriteScaled => "draw_sprite_scaled",
            Builtin::DrawSpriteRotated => "draw_sprite_rotated",
            Builtin::DrawFrame => "draw_frame",
            Builtin::DrawFrameScaled => "draw_frame_scaled",
            Builtin::SpriteWidth => "sprite_width",
            Builtin::SpriteHeight => "sprite_height",
            Builtin::FrameCount => "frame_count",
            Builtin::SetCamera => "set_camera",
            Builtin::CenterCamera => "center_camera",
            Builtin::CameraBounds => "camera_bounds",
            Builtin::CameraX => "camera_x",
            Builtin::CameraY => "camera_y",
            Builtin::Burst => "burst",
            Builtin::DrawTextScreen => "draw_text_screen",
            Builtin::DrawRectangleScreen => "draw_rectangle_screen",
    ...
    pub fn from_name(name: &str) -> Option<Builtin> {
        Some(match name {
            ...
            "read_image" => Builtin::ReadImage,
            "load_image_dataset" => Builtin::LoadImageDataset,
            "save" => Builtin::Save,
            "load" => Builtin::Load,
            ...
            "load_sprite_sheet" => Builtin::LoadSpriteSheet,
            "draw_sprite" => Builtin::DrawSprite,
            "draw_sprite_scaled" => Builtin::DrawSpriteScaled,
            "draw_sprite_rotated" => Builtin::DrawSpriteRotated,
            "draw_frame" => Builtin::DrawFrame,
            "draw_frame_scaled" => Builtin::DrawFrameScaled,
            "sprite_width" => Builtin::SpriteWidth,
            "sprite_height" => Builtin::SpriteHeight,
            "frame_count" => Builtin::FrameCount,
            "set_camera" => Builtin::SetCamera,
            "center_camera" => Builtin::CenterCamera,
            "camera_bounds" => Builtin::CameraBounds,
            "camera_x" => Builtin::CameraX,
            "camera_y" => Builtin::CameraY,
            "burst" => Builtin::Burst,
            "draw_text_screen" => Builtin::DrawTextScreen,
            "draw_rectangle_screen" => Builtin::DrawRectangleScreen,
